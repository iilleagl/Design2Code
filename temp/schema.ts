...
export interface Ellipse extends Entity, Size, CanHaveGraphics {
  ...
  /** Arc length in degrees from startAngle. Positive = clockwise, negative = counter-clockwise. Range: -360 to 360. Default: 360 (full ellipse). */
...
export interface IconFont extends Entity, Size, CanHaveEffects {
  ...
  /** Icon font to use. Valid fonts are 'lucide', 'feather', 'Material Symbols Outlined', 'Material Symbols Rounded', 'Material Symbols Sharp' */
...
export interface Document {
  ...
  themes?: {
    [
      key: string
    ]: string[] /** Each key is a theme axis (e.g. 'device'), and the value is an array of possible choices for that axis (e.g. ['phone', 'tablet', 'desktop']). */;
  };
  variables?: {
    [key: string]:
      | {
          type: "boolean";
          value: boolean | { value: boolean; theme?: Theme }[];
        }
      | { type: "color"; value: string | { value: string; theme?: Theme }[] }
      | { type: "number"; value: number | { value: number; theme?: Theme }[] }
      | { type: "string"; value: string | { value: string; theme?: Theme }[] };
  };
  children: (
    | Frame
    | Group
